%QUAT_DIST compute the distance between two quaternions.
...
% OUTPUTS:
%   -distance: the distance between q1 and q2
...
% function distance = quat_dist(q1, q2)
% 
